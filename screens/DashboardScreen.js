  ...
  return (
    <View style={styles.container}>
      <View style={styles.rectangle}>
        ...
        <Image source={require("../assets/cprgif.gif")} style={styles.cprGif} />
        <Text style={styles.subtitle}>
          Learn essential infant CPR techniques to save a life! Follow the
          tutorial, practice CPR, and enhance your skills for emergency
          situations.
        </Text>
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.button} onPress={handleTutorialPress}>
            <Text style={styles.buttonText}>
              Infant CPR Procedure and Tutorials
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={handlePracticeCPRPress}
          >
            <Text style={styles.buttonText}>
              Infant CPR Training: Practice CPR
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={handlePre_CPRPress}>
            <Text style={styles.buttonText}>
              Infant CPR Training: Implement and Assess your Skills
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={handleQuizScreenPress}
          >
            <Text style={styles.buttonText}>Test your Knowledge!</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={handlePreFourPicsPress}
          >
